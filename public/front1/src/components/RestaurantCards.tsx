...
function RestaurantCards ({CardIndividual}: {CardIndividual:RestaurantTypes}) {
    ...
    return (<>
        <div className="p-5 border-[#fc6251]/30 border-2 rounded-2xl w-90 m-5 
        flex flex-col items-center cursor-pointer hover:scale-105 transition-all">
            <img
            className="rounded-2xl h-60" 
            src={CardIndividual.image_store}></img>
            <p className="text-2xl font-bold text-white/80 mt-2">{CardIndividual.name}</p>
            <p className="text-white/60 mt-2 w-70">{CardIndividual.description}</p>
            <button
